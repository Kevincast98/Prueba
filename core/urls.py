...
from .views import (
    ...
    PersonaRetrieveUpdateDestroyView,
    PersonaFilterByDocumentoView,
    TareaListCreateView,
    TareaRetrieveUpdateDestroyView,
    TareaFilterByFechaLimiteView,
    TareaFilterByFechaLimiteRangeView,
    TareaFilterByPersonaView,
)
...
urlpatterns = [
    ...
    path('personas/documento/<str:documento>/', PersonaFilterByDocumentoView.as_view(), name='personas-filter-by-documento'),
